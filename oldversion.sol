...
contract BlokistaNFT is ERC721, Ownable {
    ...
    // Map the number of tokens per nftId This shows the amount of copy of a nft that exists.
...
function multipleMint(string[] memory _tokenURIs, uint256 _price, uint256 _amountOfToken) external returns (uint256){
    ...
    function changeListingStatus(uint256 _tokenId, bool _listedOrNot) external {
        ...
        require(haveListed[_tokenId] != _listedOrNot,"This is already in the status you requested.");
